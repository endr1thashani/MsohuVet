...
const Ushtrime = () => {
  return (
    <section className='w-full max-w-[1240px] mx-auto flex flex-col items-center mt-[100px] mb-[100px] '>
      <h1 className='font-bold text-4xl mb-[40px] text-[#0067FF]'>Ushtrime</h1>
      <div className='flex w-full items-center justify-evenly flex-col md:flex-row'>
        <div className='max-w-[450px] flex flex-col items-center bg-gray-100'>
          <div className='flex items-center justify-center bg-[#F16529] w-[330px] h-[200px] mb-[20px] rounded-sm'>
            ...
            <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#F16529] rounded-sm p-30px' to="/ushtrimihtml">Provo!</NavLink>
        </div>
        <div className='max-w-[450px] my-[25px] md:my-0 flex flex-col items-center bg-gray-100'>
          ...
          <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#4285F4] rounded-sm p-30px' to="/ushtrimicss">Provo!</NavLink>
        </div>
        <div className='max-w-[450px] flex flex-col items-center bg-gray-100'>
          ...
          <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#F0DB4F] rounded-sm p-30px' to="/ushtrimijs">Provo!</NavLink>
        </div>
      </div>
      ...
      <div className='max-w-[450px] flex flex-col items-center bg-gray-100'>
          ...
          <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#61dbfb] rounded-sm p-30px' to="/ushtrimireact">Provo!</NavLink>
        </div>
        <div className='max-w-[450px] flex flex-col items-center bg-gray-100  my-[25px] md:my-0'>
          ...
          <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#563d7c] rounded-sm p-30px' to="/ushtrimibootstrap">Provo!</NavLink>
        </div>
        <div className='max-w-[450px] flex flex-col items-center bg-gray-100'>
          ...
          <NavLink className='flex items-center  justify-center text-[#000] w-[150px] h-[50px] font-bold mb-[10px] bg-[#00b4b6] rounded-sm p-30px' to="/ushtrimitailwind">Provo!</NavLink>
        </div>
      </div>
