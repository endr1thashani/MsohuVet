          ...
          showScore ? (
            <>
              ...
              <div className='flex flex- items-center justify-center md:flex-row'>
                  <p className='m-2 h-10 w-44 flex items-center justify-center rounded-md bg-slate-200 hover:bg-slate-100 hover:shadow-xl transition-all duration-500'><NavLink to="/kuizijs">Provo përsëri!</NavLink></p>
